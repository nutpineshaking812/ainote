...
export type CustomPromptSuggestionMenuProps = {
...
export const CustomPromptSuggestionMenu = (props: CustomPromptSuggestionMenuProps) => {
  // const dict = useAIDictionary();
  const Components = useComponentsContext()!;
  // console.log("CustomPromptSuggestionMenu render");
  ...
  return (
    <div className={'bn-combobox'}>
      ...
      <Components.SuggestionMenu.Root className={'bn-combobox-items'} id={'ai-suggestion-menu'}>
        {items.map((item, i) => (
